...
class BaseLLMConfig(BaseConfig):
    ...
    temperature: float = Field(default=0.0, description="Temperature for greedy decoding")
...
class OpenAILLMConfig(BaseLLMConfig):
    ...
    api_base: str = Field(..., description="Explicit local OpenAI-compatible base URL")
