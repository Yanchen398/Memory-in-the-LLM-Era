...
class Qdrant(VectorStoreBase):
    ...
    def create_col(self, vector_size: int, on_disk: bool, distance: Distance = Distance.COSINE):
        ...
        #         default=VectorParams(size=vector_size, distance=distance, on_disk=on_disk)
        #     ),
        # )
        # self.client.create_collection(
        #     collection_name=self.collection_name,
        ...
        # self.client.create_collection(
        #     collection_name=self.collection_name,
        #     vectors_config={"default": VectorParams(size=vector_size, distance=distance, on_disk=on_disk)},
        # )
        # self.client.create_collection(
        #     collection_name=self.collection_name,
        #     vectors_config=VectorParams(size=vector_size, distance=distance, on_disk=on_disk),
        ...
        print("Creating collection with single-vector config")
