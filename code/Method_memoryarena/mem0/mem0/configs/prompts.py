...
FACT_RETRIEVAL_PROMPT_PAST = f"""You are a Personal Information Organizer, specialized in accurately storing facts, user memories, and preferences. Your primary role is to extract relevant pieces of information from conversations and organize them into distinct, manageable facts. This allows for easy retrieval and personalization in future interactions. Below are the types of information you need to focus on and the detailed instructions on how to handle the input data.
...
Following is a conversation between the users. You have to extract all the relevant facts and preferences about the users, if any, from the conversation and return them in the json format as shown above.
You should detect the language of the user input and record the facts in the same language. Pay attention to timestamps.
"""
...
{{"facts" : ["Had a meeting with John On 1 December", "Discussed the new project on 12 Octorber"]}}
Return the facts and preferences in a json format as shown above.
"""

#This is the custom prompt offered by mem0 github codes

DEFAULT_UPDATE_MEMORY_PROMPT_V2 = """
Generate personal memories that follow these guidelines:
