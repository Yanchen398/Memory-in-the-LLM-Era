...
def simple_sample(
    ...
    for session_count, key in enumerate(natural_session_keys(conversation), start=1):
...
# Use the supervised adapter while keeping this module as the LONGMEMEVAL entry point.
from .main_lme_runner import run_memoryos
